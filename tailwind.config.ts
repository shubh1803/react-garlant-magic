  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-in-left": "slide-in-left 1s cubic-bezier(0.25, 0.8, 0.25, 1)",
        "slide-in-right": "slide-in-right 1s cubic-bezier(0.25, 0.8, 0.25, 1)",
      ...
      backgroundImage: {
        ...
        "primary-gradient":
          "linear-gradient(90deg, #00c6ff, #5e00ff, #ff00aa)", // blue → purple → pink
      },
