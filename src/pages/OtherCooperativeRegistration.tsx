...
import { CheckCircle, Users, FileText, Building, Shield, BookOpen, Phone, Home, ShoppingCart, Factory, TrendingUp, GraduationCap, ChevronDown } from 'lucide-react';
    ...
    {[
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-white rounded-2xl p-6 border border-gray-200 h-full transition-all duration-500 hover:shadow-lg hover:-translate-y-1 text-center">
                    <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${category.gradient} flex items-center justify-center text-2xl text-white mx-auto mb-4 group-hover:scale-110 transition-transform`}>
                      {category.icon}
                    </div>
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        {faqs.map((faq, index) => (
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-br from-sky-500 to-teal-500 rounded-3xl p-10 text-center text-white shadow-2xl relative overflow-hidden">
