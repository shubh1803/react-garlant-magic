...
>
  ...
  <div className="hidden md:grid md:grid-cols-2 gap-8 mt-12">
    {[
      ...
      >
        {/* Circle Icon */}
       <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary-gradient border border-gray-200 flex items-center justify-center text-green-900 font-bold transition-all duration-300 group-hover:bg-blue-400 group-hover:text-white group-hover:border-transparent">
  ✓
</div>
