          ...
          <div id="faq" ref={sectionRefs.faq} className="mb-20 scroll-mt-20 px-4 relative">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Find answers to the most common questions about cooperative society audits and compliance.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              {faqs.map((faq, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl shadow-lg overflow-hidden border border-blue-100"
                >
                  {/* Question */}
                  <button
